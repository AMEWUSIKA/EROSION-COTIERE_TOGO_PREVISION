...
var style_2014_2024EPR_16 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    if ("" !== null) {
        ...
        function rules_2014_2024EPR_16(feature, value) {
            var context = {
                feature: feature,
                variables: {}
            };
            // Start of if blocks and style check logic
            if (exp_2014_2024EPR_16rule0_eval_expression(context)) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    else if (exp_2014_2024EPR_16rule1_eval_expression(context)) {
                      return [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    else if (exp_2014_2024EPR_16rule2_eval_expression(context)) {
                      return [ new ol.style.Style({
        ...
        var style = rules_2014_2024EPR_16(feature, value);
        ;
